...
> = ({
  ...
  return (
    <div className="flex items-start">
      <div className="flex flex-col w-auto min-w-70 h-auto max-h-[300px] overflow-auto border-indigo-500 !rounded-md !text-gray-500 !bg-gray-600/30 p-3 outline-none min-h-40 w-full">
        <textarea
          placeholder={placeholder}
          value={message}
          rows={2}
          className="outline-none field-sizing-content resize-none w-full min-h-[35]"
      ...
      <div className="flex flex-column items-center h-[-webkit-fill-available]">
        <IconButton
          asChild
          className={`${
